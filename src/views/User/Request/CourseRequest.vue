            ...
            <v-row>
                ...
                >
                    <v-card>
                        ...
                        <v-col cols="12" class="pl-6 py-0">
                            <v-textarea
                                placeholder="Masukkan alasan kamu mengajukan permintaan kursus disini"
                                auto-grow
                                outlined
                                dense
                                rows="4"
                ...
                <v-row class="ml-2 pt-2 pb-3 ">
                  ...
                  >
                    <v-card>
                      ...
                      <v-card-subtitle class="pb-1">Tolong Tambahkan Course mengenai React Context</v-card-subtitle>
                      <v-card-title class="text-subtitle-1 pt-0">
                        <b>Alasan</b>
                      </v-card-title>
                      <v-card-subtitle>
