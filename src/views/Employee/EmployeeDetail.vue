  ...
  <v-app>
    <v-main class="ma-5 ml-10">
      <v-container>
        ...
        <h3 class="mt-6 mb-2">
          <b>{{ getUserById.name }}</b>
        </h3>
        <div class="d-flex justify-start">
          <p class="my-auto gray6--text">Frontend Engineer</p>
          <v-btn
            ...
            @click="dialog = true"
          >
            <v-icon class="me-2">mdi-pencil-box-outline</v-icon>
            Ganti Spesialisasi
          </v-btn>
        </div>
        <!-- Dialog -->
        <v-dialog v-model="dialog" width="80%">
          <v-card>
            <v-card-title class="primary--text">
              <b>Ganti Spesialisasi</b>
            </v-card-title>
            <p class="text-h20 ml-6">Spesialisasi</p>
            <v-card-text>
              <v-select
                :items="items"
                hide-details=""
                class="align-center mx-auto"
                placeholder="Pilih Spesialisasi Baru"
                outlined
                dense
              ></v-select>
            </v-card-text>
        ...
        <v-row class="mt-1">
          <v-col class="pl-0 pr-6" cols="6">
            <v-card class="ml-3 mx-auto" width="100%" flat>
          ...
          <v-col cols="6">
            <v-card class="mx-auto" width="100%" flat>
              <v-list-item two-line>
                <v-list-item-avatar rounded size="50" color="secondary">
                  <v-icon class="my-auto" color="white">
                    mdi-phone-outline
                  </v-icon>
                </v-list-item-avatar>
        ...
        <v-col class="px-0" cols="12">
          <v-card class="ml-0 mx-auto" width="100%" flat>
            <v-list-item two-line>
              <v-list-item-avatar rounded size="50" color="secondary">
                <v-icon class="my-auto" color="white">
        ...
        <p class="text-h6 mt-2">
          <b>
            ...
            {{ getUserById.course.length }}
            Course)
          </b>
        </p>
        <v-row>
          <v-col v-for="course in getUserById.course" :key="course.ID" cols="4">
            <v-card class="mx-2 my-3" width="100%" outlined>
              <v-list-item>
                <v-list-item-content>
                  <v-list-item-avatar
                    class="mt-3"
                  ...
                  <p class="text-caption my-auto gray--text">
                    {{ course.Description }}
                  </p>
                </v-list-item-content>
              </v-list-item>
